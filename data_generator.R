#Generates the simulation results for the paper "An online generalization of the e-BH procedure"
...
FDR_online_e_lond[l]=mean(FDR)
power_online_e_lond[l]=mean(power)  
...
save(results_df, file="results/strong_signal.rda")
...
save(results_df, file="results/weak_signal.rda")
